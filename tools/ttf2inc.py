...
class TTF2INC:
    ...
    def update_font_info(self, index):
        ...
        # TODO have a char_topmost_y (etc) for each font!
    ...
    def check_unicode(self, char):
        ...
        Also update the font containing this character, searching first in font #0
        """
        index = 0
